...
--
-- Host: localhost
-- Generation Time: Jan 11, 2011 at 09:46 AM
...
CREATE TABLE IF NOT EXISTS `map_places` (
  ...
  `newPositionX` int(10) unsigned DEFAULT '0',
  `newPositionY` int(10) unsigned DEFAULT '0',
  KEY `mapId` (`mapId`),
  KEY `placeId` (`placeId`),
...
('MAP_00000000000000000000001', 'PLAC_00000000000000000000001', 0, 1, b'0', b'0', '', 0, 0),
('MAP_00000000000000000000001', 'PLAC_00000000000000000000002', 4, 2, b'0', b'0', '', 0, 0),
('MAP_00000000000000000000001', 'PLAC_00000000000000000000003', 0, 3, b'0', b'0', '', 0, 0);
