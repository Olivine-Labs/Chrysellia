...
--
-- Host: localhost
-- Generation Time: Nov 12, 2010 at 10:25 PM
...
('CHAN_00000000000000000000001', 'General', 'Welcome to Neflaria!', '2010-10-21 18:36:03'),
('CHAN_00000000000000000000002', 'Trade', 'This is the trade channel! Nefbay coming soon!', '2010-10-21 18:36:03');
...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  `inventoryId` char(28) NOT NULL,
  `name` text NOT NULL,
  `sockets` int(11) NOT NULL DEFAULT '0',
  `socketedInto` char(28) DEFAULT NULL,
  PRIMARY KEY (`itemId`),
  KEY `itemTemplateId` (`itemTemplateId`),
  KEY `inventoryId` (`inventoryId`),
  KEY `socketedInto` (`socketedInto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `item_equipment_templates`
--

CREATE TABLE IF NOT EXISTS `item_equipment_templates` (
  `itemTemplateId` char(28) NOT NULL,
...
--
-- Dumping data for table `item_equipment_templates`
--
...
--
-- Table structure for table `item_template_bonuses`
--

CREATE TABLE IF NOT EXISTS `item_template_bonuses` (
  `itemTemplateId` char(28) NOT NULL,
  `traitId` char(28) NOT NULL,
  `bonusType` int(11) NOT NULL,
  `bonus` float NOT NULL,
...
--
-- Dumping data for table `item_template_bonuses`
--
...
ALTER TABLE `items`
  ...
  ADD CONSTRAINT `items_ibfk_1` FOREIGN KEY (`socketedInto`) REFERENCES `items` (`itemId`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Constraints for table `item_bonuses`
--
ALTER TABLE `item_bonuses`
  ADD CONSTRAINT `item_bonuses_ibfk_3` FOREIGN KEY (`traitId`) REFERENCES `traits` (`traitId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `item_bonuses_ibfk_1` FOREIGN KEY (`itemId`) REFERENCES `items` (`itemId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `item_bonuses_ibfk_2` FOREIGN KEY (`itemFromId`) REFERENCES `items` (`itemId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `item_equipment_templates`
--
ALTER TABLE `item_equipment_templates`
  ADD CONSTRAINT `item_equipment_templates_ibfk_1` FOREIGN KEY (`itemTemplateId`) REFERENCES `item_templates` (`itemTemplateId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `item_template_bonuses`
--
ALTER TABLE `item_template_bonuses`
  ADD CONSTRAINT `item_template_bonuses_ibfk_2` FOREIGN KEY (`itemTemplateId`) REFERENCES `item_templates` (`itemTemplateId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `item_template_bonuses_ibfk_3` FOREIGN KEY (`traitId`) REFERENCES `traits` (`traitId`) ON DELETE CASCADE ON UPDATE CASCADE;
