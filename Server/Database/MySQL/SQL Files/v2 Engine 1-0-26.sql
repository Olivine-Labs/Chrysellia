...
--
-- Host: localhost
-- Generation Time: Jan 07, 2011 at 12:15 AM
...
CREATE TABLE IF NOT EXISTS `character_locations` (
  ...
  PRIMARY KEY (`characterId`),
  UNIQUE KEY `positionX` (`positionX`,`positionY`,`mapId`),
  KEY `mapId` (`mapId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('g8uh2rakje9lf3es8thgel71n6', 'AccountId|s:28:"ACCT_4d269ac316fa68.08014021";', '2011-01-06 23:47:11'),
('u51kg8h1litur3te0r1pip75n4', '', '2011-01-06 23:43:26');
...
ALTER TABLE `map_monster_assoc`
  ...
  ADD CONSTRAINT `map_monster_assoc_ibfk_1` FOREIGN KEY (`positionX`) REFERENCES `map_places` (`positionX`) ON DELETE CASCADE ON UPDATE CASCADE;
