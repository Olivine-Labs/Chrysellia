...
--
-- Host: localhost
-- Generation Time: Oct 07, 2010 at 10:53 PM
...
--
-- Table structure for table `characters_locations`
--

DROP TABLE IF EXISTS `characters_locations`;
CREATE TABLE IF NOT EXISTS `characters_locations` (
  `characterId` char(28) NOT NULL,
...
--
-- Dumping data for table `characters_locations`
--
...
DROP TABLE IF EXISTS `character_masteries`;
...
CREATE TABLE IF NOT EXISTS `character_traits` (
  ...
  `experienceBonus` int(11) NOT NULL,
  `alignBonus` int(11) NOT NULL,
  `strengthBonus` int(11) NOT NULL,
  `dexterityBonus` int(11) NOT NULL,
  `intelligenceBonus` int(11) NOT NULL,
  `wisdomBonus` int(11) NOT NULL,
  `vitalityBonus` int(11) NOT NULL,
  KEY `race` (`raceId`),
  KEY `characterId` (`characterId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `clan_channel_assoc`;
...
DROP TABLE IF EXISTS `clan_character_assoc`;
...
DROP TABLE IF EXISTS `inventory_item_assoc`;
...
DROP TABLE IF EXISTS `item_socket_assoc`;
...
DROP TABLE IF EXISTS `item_stat_bonuses`;
...
DROP TABLE IF EXISTS `map_monster_assoc`;
...
DROP TABLE IF EXISTS `map_place_types`;
...
DROP TABLE IF EXISTS `mastery_types`;
...
CREATE TABLE IF NOT EXISTS `races` (
  ...
  `alignRequirementMin` int(11) NOT NULL DEFAULT '0',
  `alignRequirementMax` int(11) NOT NULL,
  `strengthModifier` int(11) unsigned NOT NULL DEFAULT '0',
  `dexterityModifier` int(11) unsigned NOT NULL DEFAULT '0',
  `intelligenceModifier` int(11) unsigned NOT NULL DEFAULT '0',
  `wisdomModifier` int(11) unsigned NOT NULL DEFAULT '0',
  `vitalityModifier` int(11) unsigned NOT NULL DEFAULT '0',
  ...
  `statffMasteryMax` int(11) unsigned NOT NULL DEFAULT '0',
  ...
  `aitMasterytMax` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`raceId`),
...
--
-- Constraints for table `characters_achievements`
--
ALTER TABLE `characters_achievements`
  ADD CONSTRAINT `characters_achievements_ibfk_1` FOREIGN KEY (`characterId`) REFERENCES `characters` (`characterId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `characters_achievements_ibfk_2` FOREIGN KEY (`achievementId`) REFERENCES `achievement_types` (`achievementId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `characters_locations`
--
ALTER TABLE `characters_locations`
  ADD CONSTRAINT `characters_locations_ibfk_1` FOREIGN KEY (`characterId`) REFERENCES `characters` (`characterId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `characters_locations_ibfk_2` FOREIGN KEY (`mapId`) REFERENCES `maps` (`mapId`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `chat`
  ADD CONSTRAINT `chat_ibfk_2` FOREIGN KEY (`characterIdFrom`) REFERENCES `characters` (`characterId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chat_ibfk_1` FOREIGN KEY (`characterIdTo`) REFERENCES `characters` (`characterId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `channelId` FOREIGN KEY (`channelId`) REFERENCES `channels` (`channelId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
