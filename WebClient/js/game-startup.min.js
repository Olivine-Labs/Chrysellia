...
_("chatForm").bind("submit",function(a){a.preventDefault();a=_("chatInput")[0];var b=a.value;if(b.length>500)b=b.substr(0,500);SubmitMessage(b);a.value=""});window.$tabs=_("chatChannels").tabs({tabTemplate:'<li><a href="#{href}" class="chatChannelLabel">#{label}</a> <span class="ui-icon ui-icon-close">Remove Tab</span></li>',add:function(a,b){$(b.panel).append("<div />");$tabs.tabs("select","#"+b.panel.id)},select:function(a,b){if($(b.panel).children(".channelId").length>0){window.MyCharacter.CurrentChannel=
