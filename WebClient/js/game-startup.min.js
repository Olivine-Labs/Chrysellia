...
function(i){i.preventDefault();i=$("#itemSelection option:selected").prevAll().length;if(i<0)i=0;var n=_("itemTypeSelection")[0].value.split("|");n=$.jStorage.get("Items")[2][n[0]][n[1]];DisplayItemInfo(n[i])}),h=$("<div id='itemDescription'></div>");e=$("<div><label for='itemTypeSelection'>Shop For:</span></div>").append(d).append(e);var j={};j=$("<optgroup label='Weapons'><option value='0|0'>Swords</option><option value='0|1'>Axes</option><option value='0|2'>Staves</option><option value='0|3'>Maces</option></optgroup>");
var k=$("<optgroup label='Armors'><option value='1|0'>Armors</option><option value='1|1'>Shields</option></optgroup>"),o=$("<optgroup label='Spells'><option value='3|0'>Fire</option><option value='3|1'>Cold</option><option value='3|2'>Air</option><option value='3|3'>Heal</option></optgroup>"),l=$("<optgroup label='Accessories'><option value='2|0'>Accessories</option></optgroup>");d.append(j).append(k).append(o).append(l);b.append(e).append(f).append(g).append(h);a.append(b);b=$("<form id='sellForm'></form>");
...
function BuildAttackMessage(a,b,d,e){var f=["player","enemy"],g=["attacked","casted","healed"],h=["SMASHED","BLASTED","RECHARGED"],j="";j={};var k=$("<div class='round' />"),o=a.Rounds,l=0;d||(l=1);for(r in o)if(isInteger(r)){var i=o[r];j=i.Actor==l?"You":b;var n="";if(a.Special!==undefined&&a.Special>0)n=" <span class='monsterType "+vc.mn.MonsterSpecialTypes[a.Special]+"'>"+vc.mn.MonsterSpecialTypes[a.Special]+"</span>";if(i.Type==2){if(i.Actor==l){window.MyCharacter.Health+=i.Damage;if(window.MyCharacter.Health>
window.MyCharacter.Vitality)window.MyCharacter.Health=window.MyCharacter.Vitality;UpdateHealth()}}else if(i.Actor!=l){window.MyCharacter.Health-=i.Damage;UpdateHealth()}if(l==1)f=["enemy","player"];var p=n,q=g[i.Type];if(i.IsCritical)q="<strong>"+h[i.Type]+"</strong>";if(i.Actor==l)p="";j=i.Damage>0?$("<p class='result'><span class='attacker "+f[i.Actor]+"'>"+j+"</span>"+p+" "+q+" for <span class='damage'>"+i.Damage+"</span></p>"):$("<p class='result'><span class='attacker "+f[i.Actor]+"'>"+j+"</span>"+
p+" <span class='damage'>missed</span></p>");k.append(j)}e.append(k);if(a.Masteries!==undefined&&a.Masteries.length>0){f={};g=["Armor","Sword","Axe","Mace","Staff","Bow","Fire","Air","Cold","Earth","Shadow","Arcane"];h="";for(o=0;o<a.Masteries.length;o++){h=g[a.Masteries[o]];f=$("<p class='result mastery "+h+"'><span class='attacker player'>Your</span> <strong>"+h+"</strong> mastery has increased!</p>");k.append(f);Log("Mastery gain in "+h)}}if(a.Winner!==undefined){if(a.Winner==l){d?e.append("<div class='result wonFight'><span class='attacker player'>You</span> have defeated <span class='enemy'>"+
